          ...
          <div style={{ padding: '1rem 1.1rem 1.2rem', display: 'grid', gap: '1rem', fontSize: '0.9rem', lineHeight: 1.55 }}>
            ...
            <section>
              ...
              <p style={{ margin: '0.5rem 0 0', color: '#ddd' }}>
                <strong>To put someone on something:</strong> click it on the calendar, press the pencil, and tap their name under <strong>Who is on it</strong>. Tap more than one name if two of them are doing it. Tap a lit name to take them off. It works for anything on the calendar, not only tasks: a handover, a customer visit, even a container ETA whose date is set elsewhere. Pick nobody and it stays yours. You can do the same while creating something. They can tick their jobs off, add their own, move one to another day, and leave you a note. They can see the day&rsquo;s visits, handovers and arrivals so they know who is coming, but they cannot move any of them and they see no prices or order detail.
              </p>
              <p style={{ margin: '0.5rem 0 0', color: '#ddd' }}>
                <strong>They can tell you when a container is landing.</strong> Whoever is closest to the shipping line taps <strong>A container is arriving</strong> on their phone, picks the vehicle, and gives the date and who told them. It appears on the calendar as a report from that person and <strong>does not change the website</strong>. If it differs from the date on the product file, both are shown and &quot;dates that disagree&quot; names the difference, so you decide which one a customer is told. A supplier saying a container arrives on a date is not the same as it arriving.
              </p>
