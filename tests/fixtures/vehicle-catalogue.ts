  ...
  variants: [
    {
      ...
      platform: 'ute' as const, maxBodyLengthMm: null, correctedFields: [], promotedByOverride: false, publication: reviewedPublication,
      source: {
    ...
    },
    {
      ...
      trayState: 'included', trayMassKg: null, platform: 'ute' as const, maxBodyLengthMm: null, correctedFields: [], promotedByOverride: false, publication: reviewedPublication,
      source: {
    ...
    },
    {
      ...
      frontGawrKg: 1450, rearGawrKg: 1910, trayLengthMm: null, trayWidthMm: null,
      trayState: 'not_applicable', trayMassKg: null, platform: 'ute' as const, maxBodyLengthMm: null, correctedFields: [], promotedByOverride: false, publication: reviewedPublication,
      source: {
        manufacturer: 'Mazda Australia', title: 'Mazda BT-50 Payload Calculator',
        url: 'https://www.mazda.com.au/cars/bt-50/payload/', accessedDate: '2026-08-17',
      },
